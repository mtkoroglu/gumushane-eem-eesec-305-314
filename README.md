...
## 5. Hafta
Arabanın dinamikleriyle devam ettik. Çıkış olarak pozisyonu seçerek konum bilgisinden geri-besleme aldık. Böylece sistemimizin transfer fonksiyonu da değişmiş oldu. Ayrıca PID denetleyicimizin kazançları da yeniden ayarlanmak zorunda kaldı, çünkü artık üretilen kontrol sinyali konumu haritada bir noktaya götürmeye çalışıyor, hız kontrol probleminde olduğu gibi arabayı sabit hızda sabitlemeye çalışmıyor. Devamı gelecek...
## Video
